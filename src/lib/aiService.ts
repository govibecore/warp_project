      ...
      if (result.success && result.report) {
        ...
        const finalReport: GeneratedReport = {
          ...
          parent_variant: {
            ...
            indianHomeRoutines: deterministicReport.parent_variant.indianHomeRoutines,
            indianRecommendedCurricula: deterministicReport.parent_variant.indianRecommendedCurricula,
            ptmDiscussionGuide: deterministicReport.parent_variant.ptmDiscussionGuide,
            streamOrientation: deterministicReport.parent_variant.streamOrientation,
            benchmark,
            classLevel,
            subject,
          },
